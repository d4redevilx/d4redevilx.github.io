...
Podríamos utilizar de un diccionario de usuarios para realizar fuerza bruta, pero si recordamos nuestra enumeración inicial de samba, existe un recurso compartido llamado `helios`, que posiblemente también sea un usuario del sistema.
