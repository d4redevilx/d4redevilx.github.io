...
![Quick](/assets/img/hmvm/quick/quick.png)

|Nombre|VM Info|
|---|---|
|**Sistema operativo**|Linux|
|**Dificultad**|Fácil|
|**Fecha de lanzamiento**|2024-01-29|
|**Máquina**|[Quick](https://hackmyvm.eu/machines/machine.php?vm=Quick)|
|**Creador**|[eMVee](https://emvee-nl.github.io/)|
